...
(require graphics/graphics) ; legacy library
...
(define (list-maker-explodable)  ; it makes a list of lists
  (define (core r)               ; where each inner list has i j and the cell at i, j, such that, that cell
